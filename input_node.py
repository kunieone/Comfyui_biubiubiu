    ...
    def INPUT_TYPES(s):
        return {"required": 
                    {   
                        ...
                        "longside_size": (("INT", {"default": 1440, "min": 768, "max": 8192, "step": 8}))
                    },
        }
    
    RETURN_TYPES = ("INT", "INT", "FLOAT", "INT", "FLOAT", "FLOAT", "INT", 
                    "BOOLEAN", "BOOLEAN", "BOOLEAN", "BOOLEAN", "STRING", "BOOLEAN", "INT")
    RETURN_NAMES = ("batch size", "base step", "base cfg", "hires step", "hires cfg", "hires scale", "seed", 
                    "is pose control", "is color fix", "is hires", "is kps swapper", "fusion_style_type", "is_pose_hands", "longside_size")
    FUNCTION = "run_it"
